...
Use left/right on joystick port 2 to scroll the camera. Up/down moves only the sprite marker.
...
- Up/down: move the hires sprite marker without changing the camera.
